...
fun ArticleCardShimmerEffect(
    ...
    Row(modifier = modifier) {
        ...
        Column(
            ...
            modifier = Modifier.padding(horizontal = ExtraSmallPadding).height(
                ArticleCardSize
            )
        ) {
            Box(
                modifier = Modifier
                    .fillMaxWidth()
                    .height(30.dp).size(ArticleCardSize).padding(horizontal = MediumPadding2)
                    .shimmerEffect()
            )
            ...
            Row(verticalAlignment = Alignment.CenterVertically) {
                Box(
                    modifier = Modifier
                        .fillMaxWidth(0.5f)
                        .height(15.dp).size(ArticleCardSize).padding(horizontal = MediumPadding2)
                        .shimmerEffect()
                )
